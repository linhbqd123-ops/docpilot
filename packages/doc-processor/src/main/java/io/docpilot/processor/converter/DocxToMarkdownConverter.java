 ...
 * no production-ready Java library for DOCX → Markdown with adequate fidelity.
 *
 * <p>Supported:
 * <ul>
 *   <li>Heading 1–6 (ATX style: {@code #} … {@code ######})</li>
...
public class DocxToMarkdownConverter {
            ...
            for (Object obj : body.getContent()) {
                ...
                if (unwrapped instanceof P para) {
                    ...
                    if (styleId != null && styleId.startsWith("Heading")) {
                        ...
                        // Normal paragraph — extract inline formatting
    ...
    private int headingLevel(String styleId) {
        // "Heading1" → 1, "Heading2" → 2 … "heading1" too
        try {
    ...
    // -----------------------------------------------------------------------
    //  Text extraction — with inline Markdown formatting
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    //  Table → Markdown (GFM pipe tables)
    // -----------------------------------------------------------------------
