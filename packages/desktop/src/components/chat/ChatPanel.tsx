...
;
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="border-t border-docpilot-border p-4">
        ...
        <div className="rounded-2xl border border-docpilot-border bg-docpilot-panelAlt p-3">
          <textarea
            ...
            className="h-28 w-full resize-none border-none bg-transparent text-sm leading-6 text-docpilot-text outline-none placeholder:text-docpilot-muted/70"
