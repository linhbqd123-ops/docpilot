...
import io.docpilot.mcp.model.legacy.DocumentNode;
import io.docpilot.mcp.model.legacy.DocumentStructure;
import io.docpilot.mcp.model.legacy.PageLayout;
...
public class DocumentStructureExtractor {
    ...
    private String getText(P para, int maxChars) {
        ...
        return sb.length() > maxChars ? sb.substring(0, maxChars) + "â€¦" : sb.toString();
    }
